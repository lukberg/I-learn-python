...
class Particle(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        self.gravity = random.random()*0.2
    ...
    def update(self, seconds):
        ...
        self.x += self.dx
        self.y += self.dy
        self.dy += self.gravity * Particle.g
...
class PygView(object):
    ...
    def run(self):
        ...
        while running:
            ...
            if Particle.g == -1:
                gravity_sym = "^"
            pygame.display.set_caption("sprites: {}    fps: {:.2f}     gravity: {}".format(
                                 self.balls, self.clock.get_fps(), gravity_sym ))
